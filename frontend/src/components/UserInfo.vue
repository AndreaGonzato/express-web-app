...
export default {
  ...
  computed: {
    getName() {
      return this.userObj.name.charAt(0).toUpperCase() + this.userObj.name.substring(1);
    },
    getSurname() {
      return this.userObj.surname.charAt(0).toUpperCase() + this.userObj.surname.substring(1);
    },
  },
};
</script>
